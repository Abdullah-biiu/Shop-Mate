            ...
            <>
                    ...
                    >
                      <div className="flex items-center space-x-4">
                        ...
                        <div className="flex items-center space-x-2">
                          <button
                            className="p-1 rounded glass-card hover:glow-on-hover"
                            onClick={() =>
                              updateQuantity(
                                productId,
                                item.quantity - 1
                          ...
                          <button
                            className="p-1 rounded glass-card hover:glow-on-hover text-red-500"
                            onClick={() =>
                              dispatch(
                                removeFromCart({
                                  id: productId,
              ...
              <div className="border-t border-[hsla(var(--glass-border))] pt-4">
                ...
                <Link
                  to="/cart"
                  onClick={() => dispatch(toggleCart())}
                  className="w-full block text-center gradient-primary text-primary-foreground rounded-lg py-3 hover:glow-on-hover animate-smooth font-semibold"
                >
                  View Cart & Checkout
                </Link>
              </div>
